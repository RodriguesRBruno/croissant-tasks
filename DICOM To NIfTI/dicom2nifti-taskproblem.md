...
- Solutions must satisfy the following conditions:
  - Inputs and outputs should conform to the specifications defined in this Task Problem.
...
```json
{
    "task_definition": {
        ...
        "description": "This Task Problem defines the generalized task of converting medical images from the DICOM Format (.dcm) to NIfTI (.nii.gz)",
